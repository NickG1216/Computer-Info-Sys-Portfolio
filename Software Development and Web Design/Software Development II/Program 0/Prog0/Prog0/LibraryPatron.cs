...
public class LibraryPatron
{
    ...
    public string PatronName
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(_patronName),value,$"{nameof(PatronName)} cannot be left blank");
            }
    ...
    public string PatronID
    {
        ...
        set
        {
            if(string.IsNullOrWhiteSpace(value))
            {
                throw new ArgumentOutOfRangeException(nameof(_patronID), value, $"{nameof(PatronID)} cannot be left blank");
            }
